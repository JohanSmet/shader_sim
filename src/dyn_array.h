...
#define arr_remove_back(a,n) ((n) > arr_len((a)) ? arr_clear((a)) : (arr__hdr((a))->len -= (n)))
#define arr_push_buf(a, b, n) ((n) > 0 ? (arr__fit((a), n), memcpy(arr_end(a), (b), (n) * sizeof(*(a))), arr__hdr(a)->len+= (n)) : false)
...
#define arr_strcat(a, s) (arr_push_buf((a), (s), strlen((s))), arr__fit((a),1), (a)[arr_len((a))+1] = '\0');
